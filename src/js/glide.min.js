! function(t, e) {
	...
	function c(t, e) {
		var n = H({}, t, e);
		return e.hasOwnProperty("classes") && (n.classes = H({}, t.classes, e.classes), e.classes.hasOwnProperty("direction") && (n.classes.direction = H({}, t.classes.direction, e.classes.direction))), e.hasOwnProperty("breakpoints") && (n.breakpoints = H({}, t.breakpoints, e.breakpoints)), n
	}

	function l() {
		var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {};
		t(this, l), this.events = e, this.hop = e.hasOwnProperty
	}

	function f(e) {
		var n = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {};
		t(this, f), this._c = {}, this._t = [], this._e = new T, this.disabled = !1, this.selector = e, this.settings = c(_, n), this.index = this.settings.startAt
	}
	...
	function h(t, e, n) {
		function i() {
			c = !1 === n.leading ? 0 : d(), o = null, a = t.apply(s, u), o || (s = u = null)
		}
		...
		function r() {
			...
			c || !1 !== n.leading || (c = r);
			var l = e - (r - c);
			return s = this, u = arguments, l <= 0 || e < l ? (o && (clearTimeout(o), o = null), c = r, a = t.apply(s, u), o || (s = u = null)) : o || !1 === n.trailing || (o = setTimeout(i, l)), a
		}
		var o = void 0,
			s = void 0,
			u = void 0,
		...
		return {
			mutate: function(r) {
				for (var s = 0; s < i.length; s++) {
					var u = i[s];
					o(u) && o(u().modify) && (r = u(t, e, n).modify(r))
				}
				return r
			}
		}
	...
	function b(t) {
		return r(t) ? (e = t, Object.keys(e).sort().reduce(function(t, n) {
	...
	function w() {
		return t(this, w),
			...
			}(this, (w.__proto__ || Object.getPrototypeOf(w)).apply(this, arguments))
	}
	var _ = {
			type: "slider",
			startAt: 0,
		...
		x = (S(f, [{
			...
			value: function(t) {
				...
				return this._e.emit("mount.before"), r(e) && (this._c = function(t, e, n) {
					var i = {};
					for (var r in e) o(e[r]) && (i[r] = e[r](t, i, n));
					for (var s in i) o(i[s].mount) && i[s].mount();
					return i
		...
		A = '[data-glide-el="track"]',
		M = (S(m, [{
			key: "on",
			value: function(t, e, n, r) {
				var o = 3 < arguments.length && void 0 !== r && r;
				i(t) && (t = [t]);
				for (var s = 0; s < t.length; s++) this.listeners[t[s]] = n, e.addEventListener(t[s], this.listeners[t[s]], o)
			}
		}, {
			key: "off",
			value: function(t, e, n) {
				...
				i(t) && (t = [t]);
				for (var o = 0; o < t.length; o++) e.removeEventListener(t[o], this.listeners[t[o]], r)
			}
		}, {
			key: "destroy",
			value: function() {
	...
	var j = L,
		...
		G = {
			Html: function(t, e) {
				var n = {
					mount: function() {
						this.root = t.selector, this.track = this.root.querySelector(A), this.slides = Array.prototype.slice.call(this.wrapper.children).filter(function(e) {
				...
				return a(n, "root", {
					...
					set: function(t) {
						i(t) && (t = document.querySelector(t)), p(t) && (n._r = t)
					}
				}), a(n, "track", {
					get: function() {
						return n._t
			...
			Peek: function(t, e, i) {
				...
				return a(o, "value", {
					...
					set: function(t) {
						r(t) ? (t.before = n(t.before), t.after = n(t.after)) : t = n(t), o._v = t
					}
				}), a(o, "reductor", {
					get: function() {
						var e = o.value,
							n = t.settings.perView;
						return r(e) ? e.before / n + e.after / n : 2 * e / n
					}
			...
			Gaps: function(t, e, i) {
				var r = {
					apply: function(t) {
						for (var n = 0, i = t.length; n < i; n++) {
							var r = t[n].style,
								o = e.Direction.value;
							r[O[o][0]] = 0 !== n ? this.value / 2 + "px" : "", n !== t.length - 1 ? r[O[o][1]] = this.value / 2 + "px" : r[O[o][1]] = ""
						}
					},
					remove: function(t) {
				...
				}), i.on(["build.after", "update"], h(function() {
			...
			Clones: function(t, e, n) {
				var i = {
					...
					collect: function(n) {
						for (var i = 0 < arguments.length && void 0 !== n ? n : [], r = e.Html.slides, o = t.settings, s = o.perView, u = o.classes, a = s + +!!t.settings.peek, c = r.slice(0, a), l = r.slice(-a), f = 0; f < Math.max(1, Math.floor(s / r.length)); f++) {
							for (var d = 0; d < c.length; d++) {
								var h = c[d].cloneNode(!0);
								h.classList.add(u.cloneSlide), i.push(h)
							}
							for (var v = 0; v < l.length; v++) {
								var p = l[v].cloneNode(!0);
								p.classList.add(u.cloneSlide), i.unshift(p)
							}
						}
						return i
					},
			...
			Build: function(t, e, n) {
				var i = {
					...
					activeClass: function() {
						...
						i && (i.classList.add(n.activeSlide), v(i).forEach(function(t) {
			...
			Run: function(t, e, i) {
				var r = {
					...
					calculate: function() {
						...
						switch (o) {
							case ">":
								">" === r ? t.index = i : this.isEnd() ? t.isType("slider") && !t.settings.rewind || (this._o = !0, t.index = 0) : s ? t.index += Math.min(i - t.index, -n(r)) : t.index++;
								break;
							case "<":
								"<" === r ? t.index = 0 : this.isStart() ? t.isType("slider") && !t.settings.rewind || (this._o = !0, t.index = i) : s ? t.index -= Math.min(t.index, n(r)) : t.index--;
								break;
							case "=":
								t.index = r
						}
					...
					l = {
						...
						start: function(e) {
							if (!a && !t.disabled) {
								...
								o = null, s = n(r.pageX), u = n(r.pageY), this.bindSwipeMove(), this.bindSwipeEnd(), i.emit("swipe.start")
							}
						},
						move: function(r) {
							if (!t.disabled) {
								...
								r.stopPropagation(), e.Move.make(h * function(t) {
									return parseFloat(t)
								}(l)), e.Html.root.classList.add(f.dragging), i.emit("swipe.move")
							}
						},
						end: function(r) {
							if (!t.disabled) {
								...
								this.enable(), c < l && f < u.touchAngle ? (u.perTouch && (d = Math.min(d, n(u.perTouch))), e.Direction.is("rtl") && (d = -d), e.Run.make(e.Direction.resolve("<" + d))) : l < -c && f < u.touchAngle ? (u.perTouch && (d = Math.max(d, -n(u.perTouch))), e.Direction.is("rtl") && (d = -d), e.Run.make(e.Direction.resolve(">" + d))) : e.Move.make(), e.Html.root.classList.remove(u.classes.dragging), this.unbindSwipeMove(), this.unbindSwipeEnd(), i.emit("swipe.end")
							}
						},
						bindSwipeStart: function() {
							var n = this,
								i = t.settings;
							i.swipeThreshold && r.on(D[0], e.Html.wrapper, function(t) {
								n.start(t)
							}, c), i.dragThreshold && r.on(D[1], e.Html.wrapper, function(t) {
								n.start(t)
							}, c)
						},
						unbindSwipeStart: function() {
							r.off(D[0], e.Html.wrapper, c), r.off(D[1], e.Html.wrapper, c)
						},
						bindSwipeMove: function() {
							var n = this;
							r.on(E, e.Html.wrapper, h(function(t) {
								n.move(t)
							}, t.settings.throttle), c)
						},
						unbindSwipeMove: function() {
							r.off(E, e.Html.wrapper, c)
						},
						bindSwipeEnd: function() {
							var t = this;
							r.on(R, e.Html.wrapper, function(e) {
								t.end(e)
							})
						},
						unbindSwipeEnd: function() {
							r.off(R, e.Html.wrapper)
						},
						touches: function(t) {
							return -1 < W.indexOf(t.type) ? t : t.touches[0] || t.changedTouches[0]
						},
						threshold: function(e) {
							var n = t.settings;
							return -1 < W.indexOf(e.type) ? n.dragThreshold : n.swipeThreshold
						},
						enable: function() {
				...
				var i = new M,
					...
					o = {
						...
						addClass: function(e) {
							var n = t.settings,
								i = e[t.index];
							i && (i.classList.add(n.classes.activeNav), v(i).forEach(function(t) {
			...
			Autoplay: function(t, e, i) {
				var r = new M,
					o = {
						...
						start: function() {
							var n = this;
							t.settings.autoplay && s(this._i) && (this._i = setInterval(function() {
				...
				return a(o, "time", {
					get: function() {
						...
						return n(i || t.settings.autoplay)
					}
			...
			Breakpoints: function(t, e, n) {
				...
				return H(r, u.match(o)), i.on("resize", window, h(function() {
					t.settings = c(r, u.match(o))
	...
	return function(t, e) {
		...
		value: function(t) {
			...
			}(w.prototype.__proto__ || Object.getPrototypeOf(w.prototype), "mount", this).call(this, H({}, G, e))
		}
	}]), w
});